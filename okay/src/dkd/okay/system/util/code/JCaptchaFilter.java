package dkd.okay.system.util.code;  
...
public class JCaptchaFilter implements Filter {  
    ...
    protected boolean validateCaptchaChallenge(final HttpServletRequest request) {  
        try {  
            ...
            System.out.println("challengeResponse.toLowerCase()*******************"+challengeResponse.toLowerCase());
            if (StringUtils.isNotBlank(autoPassValue) && autoPassValue.toLowerCase().equals(challengeResponse.toLowerCase())) {               
            	return true;  
            }  
