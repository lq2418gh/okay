...
public class TenderContractHead implements Serializable{
	/**
	 * 
	 */
	...
	private String materialsPurchaseId;//物资采购审批表id
	private String purchase_no;//(前台显示用,物资采购编号串)
	...
	private List<TenderContractDetail> tenderContractDetailList;//查看页面回显数据用
	private List<TenderContractSupplier> tenderContractSupplierList;//查看页面回显数据用
	//生成框架协议使用的字段
	...
	public List<TenderContractDetail> getTenderContractDetailList() {
		return tenderContractDetailList;
	}
	public void setTenderContractDetailList(List<TenderContractDetail> tenderContractDetailList) {
		this.tenderContractDetailList = tenderContractDetailList;
	}
	public List<TenderContractSupplier> getTenderContractSupplierList() {
		return tenderContractSupplierList;
	}
	public void setTenderContractSupplierList(List<TenderContractSupplier> tenderContractSupplierList) {
		this.tenderContractSupplierList = tenderContractSupplierList;
	}
