...
/**
 * 
* @ClassName: IntermediateSupplier 
* @Description: 供应商中间表(用于记录可使用供应商再次提交审批之前的数据)
* @author linss
* @date 2017年9月8日 下午1:34:34
 */
public class IntermediateSupplier implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4804539934475837723L;
	
	private String temp_id ;  //供应商id
	...
	private String id;//原数据id
	private String year;//提交时的当年评审年份
	private String score;//提交时的当年评审等级
