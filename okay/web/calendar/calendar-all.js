...
function selectDatetime(inputField) {
    timecalendar = new Calendar(null,null,onSelecttime, function(cal) { cal.hide(); });
	timecalendar.setDateFormat("%Y-%m-%d %H:%M");
...
function onSelect(calendar, date) {
    ...
    var c_str = c_year+"-"+c_mouth+"-"+c_day;
    calendar.params.inputField.value = date;

}

function onSelecttime(calendar, date) {
    var today = new Date();
    var c_year = today.getYear();
    var c_mouth = today.getMonth()+1;
    var c_day = today.getDate();
    var c_hour = today.getHours();
    var c_minute = today.getMinutes();
    if(c_mouth<10){
       c_mouth = "0"+c_mouth;
    }
    if(c_day<10){
    ...
    var c_str = c_year+"-"+c_mouth+"-"+c_day+" "+c_hour+":"+c_minute;
    calendar.params.inputField.value = date;
...
function simpleCalendarinit() {
	datecalendar = new Calendar(null,null,simpleOnSelect, function(cal) { cal.hide(); });
	datecalendar.setDateFormat("%Y-%m-%d");
	datecalendar.showsTime = false;
	datecalendar.params = {};
	datecalendar.create();
}
function simpleSelectDate(inputField) {
	if(datecalendar == null) {
		simpleCalendarinit();
	}
	datecalendar.params.inputField = inputField;
...
function simpleSelectDatetime(inputField) {
    timecalendar = new Calendar(null,null,simpleOnSelect, function(cal) { cal.hide(); });
	timecalendar.setDateFormat("%Y-%m-%d %H:%M");
	timecalendar.showsTime = true;
	timecalendar.params = {};
	timecalendar.create();
...
function simpleOnSelect(calendar, date) {
	calendar.params.inputField.value = date;
}



function calendarinitX() {
	datecalendar = new Calendar(null,null,onSelectX, function(cal) { cal.hide(); });
	datecalendar.setDateFormat("%Y-%m-%d");
	datecalendar.showsTime = false;
	datecalendar.params = {};
	datecalendar.create();
}
function selectDateX(inputField) {
	if(datecalendar == null) {
		calendarinitX();
	}
	datecalendar.params.inputField = inputField;
...
function onSelectX(calendar, date) {
    var today = new Date();
    var c_year = today.getYear();
    var c_mouth = today.getMonth()+1;
    var c_day = today.getDate();
