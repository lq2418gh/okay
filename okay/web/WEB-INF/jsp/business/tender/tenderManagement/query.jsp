...
<body>
							...
							<div class="panel-heading">
								<h4 class="panel-title">
									<a id="example" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="display: block;">
										<span class="label label-primary">招标管理>>协议招标>>查询</span>
									</a>
								</h4>
							</div>
							<div id="collapseOne" class="panel-collapse collapse in">
								<div class="panel-body">
									<form:form name="tenderFrameHead" commandName="tenderFrameHead" id="tenderFrameHead" action="${ctx}/tender/query.do">
										<table id="queryTable" class="table table-condensed ">
											...
											<tr>
												<td colspan="6" id="tools"><input type="submit" value="查询" class="btn btn-primary btn-xs" />
													<button type="button" value="重置" onclick="resetControl('tenderFrameHead')" class="btn btn-primary btn-xs">重置 </button>
												</td>
											</tr>
										</table>
									</form:form>
					...
					<div class="panel-group" id="accordion2">
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<a class="btn btn-primary btn-xs" href='${ctx}/tender/editAndEcho.do'>新建招标</a>
							</div>
								...
								<div class="panel-body">
									<table class="table table-striped table-condensed table-hover">
										...
										<c:forEach var="t" items="${list }" varStatus="v">
											<tr>
												<td>${v.count}</td>
												<td><a href="${ctx}/tender/view.do?id=${t.id}">${t.tender_no }</a></td>
	...
	<form id="condition" name="condition"  hidden="true" method="post">
		<input type="text" name="tender_no" value="${tenderFrameHead.tender_no}">
		<input type="text" name="big_supplier_name" value="${tenderFrameHead.big_supplier_name}">
		<input type="text" name="state" value="${tenderFrameHead.state}">
		<input type="text" name="release_date_begin" value="${tenderFrameHead.release_date_begin}">
		<input type="text" name="release_date_end" value="${tenderFrameHead.release_date_end }">
		<input type="text" name="open_date_begin" value="${tenderFrameHead.open_date_begin }">
		<input type="text" name="open_date_end" value="${tenderFrameHead.open_date_end }">
	</form>
</body>
</html>