...
<body>
 	<div id="west" class="ui-layout-west" style=" float:left; width:20%; height:auto">	
 		<iframe id="treeFrame" name="treeFrame" src="${ctx }/material/publicTree.do" width="100%" height="100%" frameborder="0" scrolling="auto" ></iframe> 
 	</div>	 
	<div id="zhong" class="ui-layout-center" style="float:right; width:80%; height:auto">
		<iframe id="tabFrame" name="tabFrame" src="${ctx }/material/publicCommodityQuery.do?parentId=${parentId }&type=search" width="100%" height="100%" frameborder="0" scrolling="no" ></iframe>
	</div>
</body>
</html>
<script>
