          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h4 class="panel-title"> <a id="example" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" 
              	style="display: block;"><span class="label label-primary">基础信息管理>>供应商管理>>供应商产能说明>>查看</span></a>
              </h4>
            </div>
              ...
              <div class="panel-body">
                <table id="queryTable" class="table table-condensed ">
                  <tr>
                    ...
                    <th>物资名称</th>
                    <td><form:input path="wzname" id = "wzname" cssClass="form-control input-sm"/>
                  ...
                  <tr>
                  	<td colspan="4" id="tools">
                    	<input type="submit" value="查询" class="btn btn-primary btn-xs" onclick="capacityQuery()"/>
                      	...
                      	<a href='${ctx}/supplier/editSupplierCapacity.do?supplierId=${supplierCapacity.supplier_id}' 
      ...
      <div class="span12" style="margin-top: 10px;">
		  <div class="panel-group" id="accordion2">
		    <div class="panel panel-default">
		      <div class="panel-heading">
				<a class="btn btn-primary btn-xs" onClick="confirmAct()">
			    ...
			    <div class="panel-body" style="max-height: 580px;">
			      <table class="table table-striped table-condensed table-hover" id="mxtable">
					...
					<c:forEach items="${supplierCapacity.capacityList}" var="capacityList">
						<tr>
							<td><input type="checkbox" name="ids" /></td>
							<td>${capacityList.material.code}
								<input  name="materiel_id" type ="hidden" value="${capacityList.materiel_id}"/>  
							</td>
							<td>${capacityList.material.name}</td>
							<td>${capacityList.material.spec}</td>
							<td>${capacityList.material.unit}</td>
							<td>${capacityList.price}</td>
							<td>${capacityList.material.explain}</td>
						</tr>
					</c:forEach>
			      </table>
			    </div>
...
<form id="condition" name="condition"  hidden="true" method="post">
		<input type="text" name="wzcode" value="${supplierCapacity.wzcode}">
		<input type="text" name="wzname" value="${supplierCapacity.wzname}">
</form>
</body>
<script type="text/javascript">
//保存
function saveCapacity(){
	changeDetails("mxtable","capacityList",1);
